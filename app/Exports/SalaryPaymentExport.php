...
class SalaryPaymentExport implements FromView
{
    use Exportable;
    ...
    */
    ...
    public function view(): View
    {
        ...
        $payments = CaptainSalaryPayment::with('captain','paidBy','paymentMode')
        ...
        return view('commission-payments.salary-export', [
            'payments' => $payments,
        ]);
    }
}
