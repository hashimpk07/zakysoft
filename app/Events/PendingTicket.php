...
class PendingTicket implements ShouldBroadcastNow
{
    ...
    {
        $ticket->load('captain', 'order:id,client_order_id,client_id,email,customer_name');
        $this->ticket = $ticket;
    }
    ...
    public function broadcastWith()
    {
        return [
                'ticket' => [
                    ...
                    'captain' => [
                        'firstname' => $this->ticket->captain->firstname,
                        'lastname' => $this->ticket->captain->lastname,
                        'phone_number' => $this->ticket->captain->phone_number,
                    ],
                    'order' => [
