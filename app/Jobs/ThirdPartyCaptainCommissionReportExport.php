...
class ThirdPartyCaptainCommissionReportExport implements ShouldQueue
{
   ...
   /**
    ...
    public function getReport() 
    {
        ...
        $third_party_company_id = isset($this->request['third_party_company_id']) ? $this->request['third_party_company_id'] : '';
        ...
        ->when($third_party_company_id, function($query, $third_party_company_id) {
            $query->whereHas('captainThirdParty', function($query) use ($third_party_company_id) {
                $query->where('third_party_logistic_company_id', '=', $third_party_company_id);
            });
        })
        ...
        ->paginate(1000, ['*'], 'page', $this->page)->withQueryString();
    }
