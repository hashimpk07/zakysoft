...
class ManagementRegionBasedOrderSuccess implements Graph
{
    public function data($request = null)
    {
        ...
        $title = $quadrant ? 'ORDERS AND SUCCESS RATE BY AREA' : 'ORDERS AND SUCCESS RATE BY REGION';
        ...
        if ($quadrant) {
            ...
            foreach ($regions as $region) {
                ...
                $delivered = (int) ($data[$regionId]->delivered_orders ?? 0);
            ...
            foreach ($quadrants as $quadrant) {
                ...
                $delivered  = (int) ($data[$quadrantId]->delivered_orders ?? 0);
